 ...
 * @author alulab14
 */
public class FrmGestionarProveedores extends javax.swing.JDialog {
    ...
    void actualizarTabla(){
        ...
        lista = logica.devolverEmpresas("", "","Proveedor");
    ...
    private void initComponents() {
        ...
        jTabbedPane1.addTab("Modificar / Eliminar Proveedor", jPanel2);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(empty(txtRazonSocial)){
            ...
            if((new EmpresaBL()).agregarEmpresa((Empresa)c))
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmGestionarProveedores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmGestionarProveedores dialog = new FrmGestionarProveedores(new javax.swing.JFrame(), true);
